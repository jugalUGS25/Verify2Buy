...
import { RefreshControl, StyleSheet, Pressable, View,ImageBackground, Text,Linking, TouchableOpacity, Button, Alert, Image, ScrollView, ActivityIndicator, Modal,FlatList,Dimensions,DrawerLayoutAndroid,SafeAreaView  } from 'react-native';
...
const gethistydatas=async()=>{
  // const jsonhistValue = await AsyncStorage.getItem('histyusers');
  // console.log('jsonhistValue',jsonhistValue)
  // const jsonArray = JSON.parse(jsonhistValue) || [];
  // const hisdata=[];
  //  hisdata.push(jsonArray)
  //  console.log('list',...hisdata)
  // //  console.log('his',jsonArray)
  //  //const array = jsonArray.map(user => user)
  // //  console.log('arraydatas',array)
  // const existingData = await AsyncStorage.getItem('histyusers');
  // let historydata = existingData ? JSON.parse(existingData) : [];
  // setHistorydatas(historydata)
